/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc worker/src/worker-configuration.d.ts` (hash: 231143d3e0f3f8184bb7e0ff8685b126)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "AUTH_URL" | "ENVIRONMENT">> {}
}
