...
const definitions: Array<[string, string, ComponentDefinition['category'], string]> = [
  ...
  [
    ...
    'Rich text',
    'content',
    '<div class="wk-rich-text"><h2>Rich text heading</h2><p>Write formatted content with clear structure.</p><ul><li>List item</li></ul></div>',
  ],
  [
    'icon',
    'Icon',
    'content',
    '<span class="wk-icon" role="img" aria-label="Decorative icon">◆</span>',
  ],
  [
    'video',
    'Video',
    'media',
    '<video class="wk-video" controls preload="metadata"><track kind="captions" /><p>Video preview unavailable.</p></video>',
  ],
  [
    'audio',
    'Audio',
    'media',
    '<audio class="wk-audio" controls preload="metadata"><p>Audio preview unavailable.</p></audio>',
  ],
  [
    'embed',
    'Embed',
    'content',
    '<div class="wk-embed" data-wk-embed="placeholder"><p>Approved embed content goes here.</p></div>',
  ],
  [
    'map',
    'Map placeholder',
    'content',
    '<section class="wk-map" role="img" aria-label="Map placeholder"><p>Add a location and accessible directions.</p></section>',
  ],
  [
    'social-links',
    'Social links',
    'content',
    '<nav class="wk-social-links" aria-label="Social links"><a href="#">Social profile</a></nav>',
  ],
  ['badge', 'Badge', 'content', '<span class="wk-badge">Badge label</span>'],
  [
    'avatar',
    'Avatar',
    'media',
    '<figure class="wk-avatar"><div role="img" aria-label="Avatar placeholder">A</div><figcaption>Name and role</figcaption></figure>',
  ],
  ['logo', 'Logo', 'content', '<a class="wk-logo" href="/" aria-label="Site home">YOUR LOGO</a>'],
  [
    'list',
    'List',
    'content',
    '<ul class="wk-list"><li>List item one</li><li>List item two</li></ul>',
  ],
  [
    'table',
    'Table',
    'content',
    '<table class="wk-table"><caption>Table title</caption><thead><tr><th scope="col">Column</th></tr></thead><tbody><tr><td>Value</td></tr></tbody></table>',
  ],
  [
    'stack',
    'Stack',
    'layout',
    '<div class="wk-stack"><div>Stack item</div><div>Stack item</div></div>',
  ],
  [
    'flex-container',
    'Flex container',
    'layout',
    '<div class="wk-flex-container"><div>Flex item</div><div>Flex item</div></div>',
  ],
  ['grid', 'Grid', 'layout', '<div class="wk-grid"><div>Grid item</div><div>Grid item</div></div>'],
  [
    'repeater',
    'Repeater',
    'layout',
    '<div class="wk-repeater"><article>Repeating item</article><article>Repeating item</article></div>',
  ],
  [
    'card',
    'Card',
    'layout',
    '<article class="wk-card"><h3>Card title</h3><p>Card description.</p></article>',
  ],
  [
    'sticky-container',
    'Sticky container',
    'layout',
    '<div class="wk-sticky-container"><p>Sticky content</p></div>',
  ],
  [
    'comparison',
    'Comparison',
    'commerce',
    '<section class="wk-comparison"><h2>Compare options</h2><div class="columns"><article><h3>Option A</h3><p>Key details</p></article><article><h3>Option B</h3><p>Key details</p></article></div></section>',
  ],
  [
    'quote-request',
    'Quote request',
    'forms',
    '<section class="wk-quote-request"><h2>Request a quote</h2><form><label>Name<input required /></label><label>Email<input type="email" required /></label><button type="submit">Request quote</button></form></section>',
  ],
  [
    'locations',
    'Locations',
    'content',
    '<section class="wk-locations"><h2>Find us</h2><article><h3>Location name</h3><p>Address · Hours · Directions</p></article></section>',
  ],
  [
    'portfolio',
    'Portfolio',
    'media',
    '<section class="wk-portfolio"><h2>Selected work</h2><div class="columns"><article><h3>Project title</h3><p>Summary and outcome</p></article></div></section>',
  ],
  [
    'product-listing',
    'Product listing',
    'commerce',
    '<section class="wk-product-listing"><h2>Products</h2><div class="columns"><article><h3>Product name</h3><p>Price · Details</p></article></div></section>',
  ],
  [
    'booking',
    'Booking',
    'forms',
    '<section class="wk-booking"><h2>Book a time</h2><form><label>Date<input type="date" required /></label><button type="submit">Continue</button></form></section>',
  ],
];
