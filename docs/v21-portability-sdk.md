...
V21 provides clean static exports, scrubbed WebKiln backups, sitemap and CSV helpers, design-token output through the project backup, and a versioned component-package manifest. Exported HTML contains no GrapesJS runtime, editor controls, authentication data, workspace identifiers, secrets, or unpublished pages. Asset binaries are not invented: paths are relative and cloud asset storage remains provider-bound.
